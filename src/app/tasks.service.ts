...
export class TasksService {
  ...
  tasks: any[] = [
    {
      ...
      due_date: [
        new Date(
          'Thu Apr 01 2021 00:00:00 GMT+0200 (Eastern European Standard Time)'
        ),
        new Date(
          'Thu Apr 01 2021 00:00:00 GMT+0200 (Eastern European Standard Time)'
        ),
  ...
  tasksChanged: BehaviorSubject<Task[]> = new BehaviorSubject<Task[]>(
    this.tasks
  );
  taskUpdated: BehaviorSubject<Task> = new BehaviorSubject<Task>(
    this.currentTask
  );
  editButtonUpdated: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(
    this.editButtonDisplayed
  );
